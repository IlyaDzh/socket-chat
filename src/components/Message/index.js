...
const AudioMessage = ({ audioSrc, isMe }) => {
    ...
    useEffect(() => {
        ...
        audioRef.current.addEventListener(
            ...
            () => {
                ...
                setProgress(
                    (audioRef.current.currentTime / duration) * 100 + duration * 0.5
                );
            },
            false
        );
    ...
    return (
        <div className="message-content__bubble message-audio">
            ...
            <div
                className="message-audio__progress"
            ...
            <div className="message-audio__info">
                ...
                <span className="message-audio__info-duration">
    ...
    >
        <div className="message-inner">
            <div className="message-user">
                ...
                <div className="message-user__date">{getMessageTime(date)}</div>
            </div>
            <div className="message-content">
                <div className="message-content__name">{user}</div>
                {text && (
                ...
                {attachments && (
                    <div className="message-content__attachments">
                        {attachments.map((item, index) => (
                            <div
                                className="message-content__attachments-item"
                                key={index}
                            >
